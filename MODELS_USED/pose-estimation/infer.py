...
if __name__ == '__main__':
    ...
    # Define the paths
    detections_folder = '/scratch-shared/ivanmiert/final_events_folder/detection3000'
    frames_folder = '/scratch-shared/ivanmiert/final_events_folder/frames_10000'
    output_folder = '/scratch-shared/ivanmiert/final_events_folder/hpe_top_down'
