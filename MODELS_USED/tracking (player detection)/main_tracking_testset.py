...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='/home/ivanmiert/playerDET/checkpoints_runs/player_det_resnet18_student.pth') #default='/scratch-shared/ivanmiert/smallplayerdetection')
    ...
    parser.add_argument('--output_path', type=str, default='/scratch-shared/ivanmiert/testset/detection')
    ...
    if hparams.data_name == 'testrun':
        ...
        base_image_folder = '/scratch-shared/ivanmiert/selected_frames_for_tests/'
