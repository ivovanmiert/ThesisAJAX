...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='/scratch-shared/ivanmiert/smallplayerdetection')
    ...
    parser.add_argument('--output_path', type=str, default='/scratch-shared/ivanmiert/final_events_folder/detection3000')
