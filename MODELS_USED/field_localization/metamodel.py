...
class HRNetMetaModel(Model):
    ...
    def share_memory(self):
        self.nn_module.share_memory()  # Share the model's parameters across processes
        if hasattr(self.loss, 'share_memory'):
            self.loss.share_memory()  # Share the loss function's parameters if necessary
    ...
    def to_device(self, device):
        # Move the internal nn_module to the desired device
