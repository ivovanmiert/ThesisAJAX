...
CONFIG_PATH = '/home/ivanmiert/sportlight_folder/soccernet-calibration-sportlight/src/models/hrnet/train_config.yaml'
...
def train(cfg: DictConfig):
    ...
    save_dir = f'/scratch-shared/ivanmiert/data/experiments/{experiment_name}_{run_name}'
    metrics = [
    ...
    #torch.save(model, '/home/ivanmiert/sportlight_folder/soccernet-calibration-sportlight/src/models/hrnet/model_final.pt')
    torch.save(model, '/scratch-shared/ivanmiert/data/model_finals_full.pt')
