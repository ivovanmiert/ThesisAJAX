...
# Paths
# Paths
image_base_folder = '/scratch-shared/ivanmiert/selected_frames_for_tests'  # Update this to your root folder containing folders of frames
output_dir = '/scratch-shared/ivanmiert/testset/ball_detect'  # YOLO's output directory
